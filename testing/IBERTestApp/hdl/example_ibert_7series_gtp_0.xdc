...
## Refclk constraints
##
create_clock -name gtrefclk0_2 -period 8.0 [get_ports GTREFCLK0P_I[0]]
create_clock -name gtrefclk1_2 -period 8.0 [get_ports GTREFCLK1P_I[0]]
...
##
#set_property PACKAGE_PIN T14 [get_ports SYSCLKP_I]
#set_property IOSTANDARD DIFF_SSTL15 [get_ports SYSCLKP_I]
#set_property PACKAGE_PIN T15 [get_ports SYSCLKN_I]
